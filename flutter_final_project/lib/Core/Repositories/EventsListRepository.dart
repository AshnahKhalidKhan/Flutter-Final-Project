...
class EventsListRepository {
  ...
  Future<Stream<List<Event>>>
      readAllEventsOfOneCampusUsingUserIdOfMemberFunctionInRepositoryFile(
          String userId) async {
    try {
      final userFromFirebase = await FirebaseFirestore.instance
          .collection('Users')
      ...
      print(
          'Error in EventRepository, readAllEventsOfOneCampusUsingUserId: $e');
      return Stream<List<Event>>.empty();
    }
  }
  ...
  Future<void> deleteEventFunctionInEventRepositoryFile(String eventId) async {
    try {
      await FirebaseFirestore.instance
          .collection('Events')
          .doc(eventId)
