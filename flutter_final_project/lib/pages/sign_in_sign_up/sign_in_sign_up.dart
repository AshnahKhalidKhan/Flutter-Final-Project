        ...
        child: Column(children: [
          ...
          BlocConsumer<AuthenticationBloc, AuthenticationState>(
            ...
            if (state is AuthenticationSuccessState) {
              ...
              } else if (state.user.role.startsWith('Admin') &&
              ...
              } else if (state.user.role.startsWith('Member') &&
                  state.user.approved! == true) {
                Navigator.pushNamedAndRemoveUntil(
                  context,
                  '/HomePage',
              ...
              } else if (state.user.role.startsWith('Lead') &&
                  state.user.approved! == true) {
                Navigator.pushNamedAndRemoveUntil(
                  context,
                  '/HomePage',
              ...
              ScaffoldMessenger.of(context)
                  .showSnackBar(passwordResetMessageSnackBarMessage);
            }
          }),
        ]),
      ),
...
class _SignUpTabState extends State<SignUpTab> {
  ...
  @override
  Widget build(BuildContext context) {
    List<DropdownMenuEntry<String>> campusEntries =
        ...
        child: Column(children: [
                    ...
                    if (snapshot.hasError) {
                      ...
                      return DropdownMenu<String>(
                        ...
                        width: MediaQuery.sizeOf(context).width -
                            60.0, //Crazy maths here, Ash!!
                        controller: campusController,
                        enableFilter: false,
                        leadingIcon: Icon(Icons.school_rounded,
                            color: Theme.of(context).colorScheme.primary),
                        label: Text(
                          'GDSC Campus Name',
                          style: TextStyle(
                        ...
                        onSelected: (String? campus) {
                          ...
                          if (fullNameCorrect &&
                              emailCorrect &&
                              passwordMinimum8Characters &&
                              passwordHasOneUppercaseAlphabet &&
                              passwordHasOneDigit &&
                              passwordHasOneSpecialCharacter &&
                              confirmPasswordAndPasswordMatch &&
                              selectedCampus != null) {
                            setState(() {
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              labelText: 'Full Name',
              helperText: fullNameActive
                  ? (fullNameCorrect ? null : 'Each word must be capitalized.')
                  : null,
              suffixIcon: fullNameActive
                  ? (fullNameCorrect ? GreenCheckIcon : RedCrossIcon)
                  : null,
            ),
            onChanged: (value) {
              if (RegExp(r'^[a-zA-Z\s]+$').hasMatch(fullNameInput.text) ==
                      true &&
                  (RegExp(r'\b[A-Z]').allMatches(fullNameInput.text).length ==
                          fullNameInput.text.split(' ').length) ==
                      true) {
                setState(() {
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              labelText: 'Email',
              helperText: emailActive
                  ? (emailCorrect ? null : 'Email must be valid.')
                  : null,
              suffixIcon: emailActive
                  ? (emailCorrect ? GreenCheckIcon : RedCrossIcon)
                  : null,
            ),
            onChanged: (value) {
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              helperText: confirmPasswordActive
                  ? (confirmPasswordAndPasswordMatch
                      ? null
                      : 'Passwords do not match.')
                  : null,
              suffixIcon: confirmPasswordActive
                  ? (confirmPasswordAndPasswordMatch
                      ? GreenCheckIcon
                      : RedCrossIcon)
                  : null,
          ...
          BlocConsumer<AuthenticationBloc, AuthenticationState>(
            ...
            return ElevatedButton.icon(
              style: ButtonStyle(
                backgroundColor: allInputFieldsCorrect
              ...
              onPressed: !allInputFieldsCorrect
                  ? null
                  : () {
                      BlocProvider.of<AuthenticationBloc>(context).add(
            ...
            if (state is AuthenticationSuccessState) {
              ...
              ScaffoldMessenger.of(context)
                  .showSnackBar(signUpErrorSnackBarMessage);
            }
          }),
        ]),
      ),
