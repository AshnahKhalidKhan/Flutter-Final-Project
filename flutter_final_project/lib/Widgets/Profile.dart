                ...
                (
                  ...
                  (
                    onTap: ()
                    {
                      ...
                      BlocProvider.of<ThemeColorBloc>(context).add(ChangeThemeColorEvent(GoogleBlue));
                    }
                  ),
                ),
                CircleAvatar
                (
                  ...
                  (
                    onTap: ()
                    {
                      ...
                      BlocProvider.of<ThemeColorBloc>(context).add(ChangeThemeColorEvent(GoogleRed));
                    }
                  ),
                ),
                CircleAvatar
                (
                  ...
                  (
                    onTap: ()
                    {
                      ...
                      BlocProvider.of<ThemeColorBloc>(context).add(ChangeThemeColorEvent(GoogleYellow));
                    }
                  ),
                ),
                CircleAvatar
                (
                  ...
                  (
                    onTap: ()
                    {
                      ...
                      BlocProvider.of<ThemeColorBloc>(context).add(ChangeThemeColorEvent(GoogleGreen));
                    }
                  ),
                ),
              ],
